...
package com.better.codingAlarm.view
...
import com.better.codingAlarm.background.PluginAlarmData
import com.better.codingAlarm.background.TargetVolume
import com.better.codingAlarm.configuration.Prefs
import com.better.codingAlarm.configuration.Prefs.Companion.MAX_PREALARM_VOLUME
...
import com.better.codingAlarm.util.subscribeIn
...
class VolumePreference(mContext: Context, attrs: AttributeSet) : Preference(mContext, attrs) {
  ...
  /** Called from [com.better.codingAlarm.presenter.SettingsFragment.onResume] */
  fun onResume() {
  ...
  /** Called from [com.better.codingAlarm.presenter.SettingsFragment.onPause] */
  fun onPause() {
    stopMasterSample()
    stopPrealarmSample()
  }
